...
//			System.out.println(favouriteDto);
			...
			favourite.setEnding_location(favouriteDto.getEnding_location());
			favourite.setMode(favouriteDto.getMode());
			favourite.setStarting_location(favouriteDto.getStarting_location());
			favourite.setStarting_time(favouriteDto.getStarting_time());
